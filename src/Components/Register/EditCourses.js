...
const EditCourses = () => {
    ...
    const handelsavedetails = async () => {
        ...
        let response = await fetch(`${process.env.REACT_APP_API_URL}/courses/${Course}`, {
            method: "PUT",
            body: bodyContent,
            headers: headersList
        });
    ...
    const retrivedetailscourse = async () => {
        let headersList = {
            "Accept": "*/*",
        }
        ...
        if (response.ok) {
            ...
            setCourseLink(data.course_link);
            setCourseTag(data.course_tag);
            setdetails(data.details);
            setInputFields(data.course_list);
        }
                                                ...
                                                <div className="mb-10">
                                                    <div className="flex justify-between">
                                                        ...
                                                        <div className="">
                                                            ...
                                                            <select
                                                                onChange={(evnt) => handleChange(index, evnt)}
                                                                className="form-select" value={data.currency} id="currency" name="currency">
