...
const Page5Table = () => {
    return (
        <>
            {/* INSTRUCTION TABLE */}
            <div id="instruction" className="instruction  md:w-[80vw] mx-auto">
...
<ul class="space-y-4 list-disc list-inside">
    ...
    <li>
        ...
        {/* SAVE MONEY TABLE */}
        <div id="savemoney" className="SAVE MONEY  md:w-[80vw] mx-auto">
          <section className="rounded-xl">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
              <div className="mb-8 lg:mb-16">
                <h2 className="mb-4 text-center text-3xl tracking-tight font-bold text-gray-900">
         ...
         {/* JOB AGENCIES TABLE */}
                <div id='jobagencies' className="JOB AGENCIES  md:w-[80vw] mx-auto">
          <section className="rounded-xl">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
              <div className="mb-8 lg:mb-16">
                <h2 className="mb-4 text-center text-3xl tracking-tight font-bold text-gray-900">
            ...
            {/* WIFI TABLE */}
            <div id="wifi" className="WIFI  md:w-[80vw] mx-auto">
          <section className="rounded-xl">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
              <div className="mb-8 lg:mb-16">
                <h2 className="mb-4 text-center text-3xl tracking-tight font-bold text-gray-900">
         ...
         {/* TAX CALCULATOR TABLE */}
                <div id="taxcalculate" className="TAX CALCULATOR  md:w-[80vw] mx-auto">
          <section className="rounded-xl">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
              <div className="mb-8 lg:mb-16">
                <h2 className="mb-4 text-center text-3xl tracking-tight font-bold text-gray-900">
