...
export default function NewScholars() {
    ...
    const actionBodyTemplate = (rowData) => {
        ...
        return (
            <button className="bg-blue-500 text-white w-20 p-2 rounded-md" onClick={handleClick}>Visit</button>
        );
    };
    ...
    return (
       ...
       <div className="py-4 px-4">
            ...
            <DataTable value={customers} paginator rows={5} rowsPerPageOptions={[5, 10, 25, 50]} tableStyle={{ minWidth: '50rem' }}>
                ...
                <Column field="startTime" header={<p className="text-lg">StartTime</p>} style={{ width: '25%' }}></Column>
                <Column field="endTime" header={<p className="text-lg">EndTime</p>} style={{ width: '25%' }}></Column>
                <Column field="price" header={<p className="text-lg">Price</p>} style={{ width: '25%' }}></Column>
                <Column header={<p className="text-lg">Official website</p>} body={actionBodyTemplate} style={{ width: '25%' }}></Column>
            </DataTable>
        </div>
    );
}
